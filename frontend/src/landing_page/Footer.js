...
function Footer() {
    return (
        <footer className='border-top mt-5' style={{backgroundColor: "rgb(227, 227, 227)"}}>
        <div className="container" >
            <div className='row mt-5'>
                <div className='col'>
                    <img src="media/images/LucidTradeLogo.png
" style={{ width: "50%"}}/>
                    <p>
                        &copy; 2025-2026, LucidTrade. All rights reserved.
                    </p>
                </div>
                <div className='col'>
                    <p>Company</p>
                    ...
                    <a href="" className='footer-link'>LucidTrade Cares (CSR)</a> <br/>
                    <a href="" className='footer-link'>LucidTrade.tech</a> <br/>
                ...
                <div className='col'>
                    ...
                    <a href="" className='footer-link'>complaints</a> <br/>
                ...
                <div className='col'>
                    ...
                    <a href="" className='footer-link'>HUF demat account</a> <br/>
            ...
            <p>LucidTrade Broking Ltd.: Member of NSE, BSE, MCX & MSEI – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through LucidTrade Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: LucidTrade Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@LucidTrade.com, for DP related to dp@LucidTrade.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF
            </p>
